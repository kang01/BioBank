...
public class PositionDestroy extends AbstractAuditingEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_position_destroy")
    @SequenceGenerator(name = "seq_position_destroy",sequenceName = "seq_position_destroy",allocationSize = 1,initialValue = 1)
    private Long id;
