...
public class StockOutBoxPosition extends AbstractAuditingEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_stock_out_box_position")
    @SequenceGenerator(name = "seq_stock_out_box_position",sequenceName = "seq_stock_out_box_position",allocationSize = 1,initialValue = 1)
    private Long id;
