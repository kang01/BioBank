...
public class StockOutFiles extends AbstractAuditingEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_stock_out_files")
    @SequenceGenerator(name = "seq_stock_out_files",sequenceName = "seq_stock_out_files",allocationSize = 1,initialValue = 1)
    private Long id;
