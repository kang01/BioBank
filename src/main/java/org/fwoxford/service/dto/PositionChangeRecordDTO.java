...
/**
 * A DTO for the PositionChangeRecord entity.
 */
public class PositionChangeRecordDTO extends AbstractAuditingDTO implements Serializable {
    ...
    public Long getPositionChangeId() {
        return positionChangeId;
    }

    public void setPositionChangeId(Long positionChangeId) {
    ...
    public boolean equals(Object o) {
        ...
        PositionChangeRecordDTO positionChangeRecordDTO = (PositionChangeRecordDTO) o;

        if ( ! Objects.equals(id, positionChangeRecordDTO.id)) { return false; }
    ...
    public String toString() {
        return "PositionChangeRecordDTO{" +
            ...
            ", positionChangeId=" + positionChangeId +
