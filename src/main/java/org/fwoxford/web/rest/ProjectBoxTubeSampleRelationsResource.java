...
@RestController
@RequestMapping("/api")
public class ProjectBoxTubeSampleRelationsResource {

    private final Logger log = LoggerFactory.getLogger(ProjectBoxTubeSampleRelationsResource.class);

    private static final String ENTITY_NAME = "relations";

    private final RelationsService relationsService;

    public ProjectBoxTubeSampleRelationsResource(RelationsService relationsService) {
