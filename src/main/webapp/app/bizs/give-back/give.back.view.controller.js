...
(function() {
    ...
    angular
        .module('bioBankApp')
        .controller('GiveBackViewController', GiveBackViewController);

    GiveBackViewController.$inject = ['$q','MasterData','$stateParams','TranshipBoxByCodeService','frozenBoxByCodeService','GiveBackService'];
    function GiveBackViewController($q,MasterData,$stateParams,TranshipBoxByCodeService,frozenBoxByCodeService,GiveBackService) {
