...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/konva/konva.min.js',
            'src/main/webapp/bower_components/jquery-mousewheel/jquery.mousewheel.js',
            ...
            'src/main/webapp/bower_components/echarts/map/js/china.js',
            ...
            'src/main/webapp/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.js',
